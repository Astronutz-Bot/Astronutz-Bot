...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    message.reply(
      "Thanks for submitting a bug!, we will check your report and fix it as soon possible. \n Join Our Server to get your bug answer: \n https://discord.gg/gU7XAxTpX5 "
    );
    channels
      .createInvite({
        temporary: `${check}`,
      ...
      .then(InviteCode =>
        client.channels.cache.get("856113699773087754").send(
